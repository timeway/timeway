# Timeway
![gamestatus shields.io](https://img.shields.io/badge/Game%20status-developing-blue.svg)
...
| ------ | -------------------------- | ------------------------------------------------------------------ | -------------------------------------------- | -------------------- | -------------------- | ----------- |
| CT-01  | Movimentação do personagem | Apertar nas teclas: `a`, `d`, `arrow left`, `arrow right`, `space` | Personagem se mover, seja pulando ou andando | `Em desenvolvimento` | `Em desenvolvimento` |             |